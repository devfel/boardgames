...
<p align="center"> 
A responsive react project done to list top trending bord games. Project was built using JSON to fetch the data from the Board Game Atlas API. This project list the games, show each of their ratings and show a little description on mouseover.
</p>
